...
public class Contest {
    ...
    // Isian berupa kalender waktu
    @Column(name = "contest_start_date")
    @DateTimeFormat(iso= DateTimeFormat.ISO.DATE_TIME)
    private LocalDateTime startDate;

    // Field berupa pilihan lomba yang private atau public
    @Column(name = "contest_private")
    private int isPrivate;

    // Auto generate dari username saat membuat lomba
    @Column(name = "contest_creator_username")
    private String creatorUsername;

    // Relasi many to many
    // satu kompetisi bisa memiliki banyak problems yang harus dipecahkan
    //  satu problems bisa dimiliki banyak kompetisi
