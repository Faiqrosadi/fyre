...
import com.fyre.services.CountryService;
import com.fyre.services.FileUploadService;
import com.fyre.services.UserService;
import com.fyre.validators.EditUserFormValidator;
import com.fyre.validators.FileUploadValidator;
...
public class ProfileController {
    ...
    public String getEditPage(@PathVariable String username, Model model, RedirectAttributes redirectAttributes) {
        ...
        model.addAttribute("universities", countryService.getAllUniversities());
        return "profile/edit";
    }
